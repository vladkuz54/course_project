...
function GraphPage() {
    ...
    function handleAddEdgeSourceChange(e) {
        setAddEdgeSource(e.target.value);
    }

    
    function handleAddEdgeChange(e) {
        setAddEdgeTarget(e.target.value);
    }
    ...
    function handleDeleteEdgeSourceChange(e) {
        setDeleteEdgeSource(e.target.value);
    }

    function handleDeleteEdgeTargetChange(e) {
        setDeleteEdgeTarget(e.target.value);
    }
    ...
    async function fetchDfsData(startNode) {
        if (!startNode) {
            console.error('Start node is required');
            return;
        }
                ...
                {action === 'addEdge' && (
                    <>
                        <InputStyle
                            ...
                            value={addEdgeSource}
                            onChange={handleAddEdgeSourceChange}
                ...
                {action === 'deleteEdge' && (
                    <>
                        <InputStyle
                            ...
                            onChange={handleDeleteEdgeSourceChange}
                        ...
                        <InputStyle
                            ...
                            onChange={handleDeleteEdgeTargetChange}
                            onKeyDown={(e) => handleKeyDown(e, 'deleteEdge')}
                        />
                ...
                {action === 'deleteNode' && (
                    <>
                        <InputStyle
                            ...
                            value={deleteNode}
                            onChange={handleDeleteNodeChange}
